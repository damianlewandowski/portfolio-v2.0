    ...
    <section className="About">
      <div className="About-container">
        ...
        <ul className="About-links">
          <li>
            <a href="https://github.com/damianlewandowski" target="_blank" rel="noopener noreferrer">
            <div className="fa-2x">
          ...
          <li>
            <a href="https://www.freecodecamp.org/damianlewandowski" target="_blank" rel="noopener noreferrer">
              <div className="fa-2x">
          ...
          <li>
            <a href="https://www.linkedin.com/in/damian-lewandowski" target="_blank" rel="noopener noreferrer">
              <div className="fa-2x">
          ...
          <li>
            <a href="https://www.codewars.com/users/damianlewandowski" target="_blank" rel="noopener noreferrer">
              <div className="fa-2x">
